...
TeamPilot is a client-side web app: no backend, no accounts, no secrets in the repository. Team and lineup data stays in the browser (`localStorage`).
...
If you find a security issue, open a [GitHub Security Advisory](https://github.com/ingmarstruijs/TeamPilot/security/advisories/new) or email the maintainer privately. Do not post exploit details in public issues before a fix is available.

## Maintainer checklist (GitHub.com)

### 1. Dependabot alerts

1. Open **https://github.com/ingmarstruijs/TeamPilot/settings/security_analysis**
...
1. Open **https://github.com/ingmarstruijs/TeamPilot/settings/branches**
...
1. Open **https://github.com/ingmarstruijs/TeamPilot/settings/actions**
...
1. **https://github.com/ingmarstruijs/TeamPilot/settings/pages**
2. **Build and deployment** → Source: **GitHub Actions**

### 5. What you do not need for TeamPilot
